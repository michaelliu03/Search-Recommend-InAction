...
def get_news_pool(start_date, end_date):
    ...
    while start_date <= end_date:
        ...
        print('Extracting news-2020-04-26-part2-2020-04-26-part1-2020-04-26-2020-04-22-part2-2020-04-22-part1-2020-04-21.4.20 urls at %s' % date_str)
...
def crawl_news(news_pool, min_body_len, doc_dir_path, doc_encoding):
    ...
    for n, news in enumerate(news_pool):
        ...
        try:
            response = urllib.request.urlopen(req, timeout=10)
            html = response.read()
        #            response = urllib.request.urlopen(news-2020-04-26-part2-2020-04-26-part1-2020-04-26-2020-04-22-part2-2020-04-22-part1-2020-04-21.4.20[1])
        except socket.timeout as err:
            print('socket.timeout')
            print(err)
...
if __name__ == '__main__':
    ...
    print('Starting to crawl %d news-2020-04-26-part2-2020-04-26-part1-2020-04-26-2020-04-22-part2-2020-04-22-part1-2020-04-21.4.20' % len(news_pool))
