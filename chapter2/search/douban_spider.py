...
###这个爬虫是从git上扒下来的，为了节省时间，没有自己编写编写这部分代码。
###原爬虫的地址参考：https://github.com/lanbing510/DouBanSpider，这是一个python2的版本，自己修改成了python3的版本
...
def book_spider(book_tag):
    ...
    while (1):
        ...
        # 用 urllib.request.quote 替换 urllib.quote
